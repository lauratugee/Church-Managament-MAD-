...
import com.example.churchmanagementsystem.models.RegistrationRequest
...
interface ApiService {
    ...
    @POST("auth/register")
    suspend fun registerUser(@Body registrationRequest: RegistrationRequest):Response<User>
    @GET("users")
